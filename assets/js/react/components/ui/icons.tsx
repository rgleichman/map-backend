...
/** Heroicons outline speaker-wave (unmuted). */
export function SpeakerWaveIcon({ className, size = 16 }: IconProps) {
  return (
    <svg {...baseSvgProps(size, className)}>
      <path
        strokeLinecap="round"
...
/** Heroicons outline speaker-x-mark (muted). */
export function SpeakerXMarkIcon({ className, size = 16 }: IconProps) {
  return (
    <svg {...baseSvgProps(size, className)}>
      <path
        strokeLinecap="round"
